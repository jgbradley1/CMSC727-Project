% A driver program to run an ESN that does NOT have backpropgation connections from
% output to reservoir.
...
%}
disp 'Training ESN...'
net = train_esn2(net, 'data/power', 4000, 10);
...
%}
disp 'Testing ESN...'
net = test_esn2(net, 'data/power', 1000);
