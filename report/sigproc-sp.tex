...
\subsection{Data}
Selection of the datasets used in our study was very important. To ensure a fair comparison of the echo state network and other supervised learning methods when applied to time series forecasting, datasets exhibiting specific traits must be chosen.
